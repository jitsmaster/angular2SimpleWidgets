...
//aw- note: TypeAhead is not using this pipe at all. This file is from the legacy package. Left here as reference
//on how async pipe works.
//TypeAhead is using the beta | async pipe for results
